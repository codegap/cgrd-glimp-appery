...
//            dataType: 'json',
    ...
    $t.adjustContentHeight = function () {
        //ETST-14391 adjust height only if it is an iPad screen (IPad template only has .content-primary and .content-secondary sections)
        if ($("#" + Appery.CurrentScreen + " .content-primary").length && $("#" + Appery.CurrentScreen + " .content-secondary").length 
            && $(window).width() >= 650) {
